        ...
        return acc + `
            <div class="column card is-one-quarter id="producto-${element.id}">
                ...
                <footer class="card-footer">
                    ...
                    <button id="boton-${element.id}" class="btn-remove-cart button card-footer-item has-background-primary">
...
botonBorrarCarrito.onclick = () => {
    ...
    document.querySelector("#container-carrito").innerHTML = "No hay productos en el carrito."
